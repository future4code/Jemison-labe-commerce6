...
import { DivComCards, DivPai, FiltroHeaderDiv, Footer, HeaderComBusca, Home, NavFiltro, Logo, TextFooter, ImgFooter, DivCarrinho } from './style.js';
//imagens
...
function App() {
  ...
  function CompraFinalizada() {
    ...
    return (
      alert("compra Finalizada Com Sucesso!" + "Prepare seu traje espacial!"))
  }
